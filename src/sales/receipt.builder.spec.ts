...
describe('buildReceipt', () => {
  const sale: SaleWithItemsAndUser = {
    id: 'sale-1',
    userId: 'user-1',
    totalAmount: new Prisma.Decimal('17.98'),
    receiptNoInt: 1234,
    paymentMethod: PaymentMethod.CASH,
    paidAmount: new Prisma.Decimal('20.00'),
    cashAmount: new Prisma.Decimal('20.00'),
    cardAmount: null,
    changeAmount: new Prisma.Decimal('2.02'),
    discountAmount: new Prisma.Decimal('2.00'),
  ...
  it('maps totals and item lines correctly', () => {
    ...
    expect(receipt.totals.discount).toBeCloseTo(2, 2);
    expect(receipt.totals.tax).toBeCloseTo(0, 2);
    expect(receipt.totals.total).toBeCloseTo(17.98, 2);
